...
evaluator_base = "Enformer_Borzoi_TestSetOverlap"
# Name of the file being used for predictions
input_file = 'enformer_borzoi_test_seqs.parquet'
measurements = 'ENCFF972GVB.bigWig'
...
MEASURED_DATA_PATH = os.path.join(EVALUATOR_DATA_DIR, measurements)
